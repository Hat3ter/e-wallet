...
export const addNewCard = (props, dispatch, cardName, currency) => {
    ...
    fetchTemplate('http://localhost:8080/wallets', {
        method: 'POST',
        headers: {
            'Accept': 'application/json',
            'Content-Type': 'application/json',
...
export const cashIn = (props, dispatch, amount) => {
    ...
    fetchTemplate(`http://localhost:8080/wallets/${props.value.id}/cash-in`, {
        method: 'PATCH',
        headers: {
            'Accept': 'application/json',
            'Content-Type': 'application/json',
...
export const cashOut = (props, dispatch, amount) => {
    ...
    fetchTemplate(`http://localhost:8080/wallets/${props.value.id}/cash-out`, {
        method: 'PATCH',
        headers: {
            'Accept': 'application/json',
            'Content-Type': 'application/json',
...
export const transfer = (props, dispatch, amount, recipientId) => {
    ...
    fetchTemplate(`http://localhost:8080/wallets/${props.value.id}/transfer`, {
        method: 'PATCH',
        headers: {
            'Accept': 'application/json',
            'Content-Type': 'application/json',
